...
class GeminiClient:
    ...
    def _build_chunk_prompt(self, content: str, section_type: str) -> str:
        ...
        return f"""Summarize this {section_type} section concisely.
...
Summary:"""
    ...
    def _build_aggregation_prompt(self, summaries: List[str], title: str) -> str:
        ...
        return f"""Create concise section-wise summaries from these chunk summaries.

{title_context}Format as:

**Problem**
[1-2 sentences on research problem and significance]

**Methods** 
[1-2 sentences on methodology and approach]

**Results**
[1-2 sentences on key findings]

**Implications**
[1-2 sentences on applications and significance]

**Limitations**
[1-2 sentences on limitations and future work]

Be direct and concise. Focus on essential information only.
